...
| **Pessoa 2** | 🐍 Implementação (Python) e Análise Crítica | - Implementação completa do Rabin–Karp em **Python**<br>- Execução dos experimentos e coleta de dados para a Linguagem 2<br>- Análise do **pior caso** e **caso médio** (ex: maior número de colisões ou shifts)<br>- Discussão sobre **aplicabilidade prática** (comparação KMP vs. Rabin–Karp vs. busca ingênua) |
